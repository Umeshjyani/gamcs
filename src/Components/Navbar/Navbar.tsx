...
export default function Navbar({ isScrolled }: { isScrolled: boolean }) {
    ...
    return (
        <div>
            <div className={`z-50 flex w-full justify-between px-4 py-5 text-sm bg-gray-100 transition duration-300 ease-in-out ${isScrolled ? 'shadow-lg' : ''}`}>
                <section className="flex items-center gap-10">
                    <div className="block md:hidden">GAMCS</div>
