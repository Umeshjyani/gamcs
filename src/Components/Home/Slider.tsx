        ...
        <div className="relative w-full h-[200px] md:h-[400px] lg:h-[450px] overflow-hidden">
            {slides.map((slide, index) => (
                <div key={index}
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-white to-transparent opacity-80 pointer-events-none" style={{ background: 'linear-gradient(to right, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 0.6) 25%, rgba(255, 255, 255, 0) 75%)' }} />
