...
export default function Slider() {
    ...
    return (
        <div className="relative w-full h-[180px] sm:h-[300px] md:h-[400px] lg:h-[450px] overflow-hidden">
            {slides.map((slide, index) => (
                <div key={index}
                    ...
                    <div className="absolute bottom-10 left-5 flex justify-center space-x-2 sm:space-x-4">
                        {slides.map((_, index) => (
                            <button
                                key={index}
                                onClick={() => setCurrentSlide(index)}
